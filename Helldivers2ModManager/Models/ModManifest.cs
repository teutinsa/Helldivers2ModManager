...
public static class ModManifest
{
    ...
    public static IModManifest DeserializeFromDirectory(DirectoryInfo dir)
    {
    ...
    public static IModManifest DeserializeFromFile(FileInfo file)
    {
    ...
    public static IModManifest DeserializeFromDocument(JsonDocument doc)
    {
        ...
        {
            ManifestVersion.Legacy => LegacyModManifest.Deserialize(root),
